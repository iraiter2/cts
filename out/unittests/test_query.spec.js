...
Tests for TestQuery
`;
import { TestQueryMultiFile, TestQueryMultiTest, TestQueryMultiCase, TestQuerySingleCase } from '../common/framework/query/query.js';
...
g.test('toString').fn(t => {
  ...
  t.expectToString(new TestQuerySingleCase('s', ['a', 'b'], ['c', 'd'], {
    x: 1,
    y: 2
  }), 's:a,b:c,d:x=1;y=2');
